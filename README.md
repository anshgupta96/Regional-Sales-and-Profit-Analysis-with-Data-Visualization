...
Imported data from an Excel sheet into a Pandas DataFrame. Performed necessary data cleaning, including handling missing values and correcting data types.

**Data Analysis**

Calculated the total and average sales and profit by region. Aggregated data to get insights into regional performance.
